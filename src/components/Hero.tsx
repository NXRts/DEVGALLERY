    ...
    <section className="max-w-6xl mx-auto px-6 pt-24 pb-32">
      <div className="flex flex-col lg:flex-row items-center gap-16">
        <div className="flex-1 space-y-8">
          ...
          >
            <button className="bg-primary text-white px-8 py-4 rounded-lg font-bold text-lg hover:shadow-xl hover:shadow-primary/20 transition-all cursor-pointer hover:-translate-y-1">
              View Work
            </button>
            <button className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-all cursor-pointer hover:-translate-y-1">
              Let's Talk
            </button>
          </motion.div>
        </div>
